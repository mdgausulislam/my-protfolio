...
export default function Services() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 mt-6 items-center lg:px-10 w-full">
      <Card
      ...
      >
        <CardContent className="mx-5">
          ...
          <p className="text-base space-y-10">
            ...
            craft stunning, responsive, and user-friendly designs that not only
            captivate but also convert visitors into loyal customers.
            Specializing in modern technologies and best practices, I bring your
      ...
      >
        <CardContent className="mx-6">
          ...
          <p className="text-base space-y-10">
            ...
            specialize in crafting intuitive, user-friendly interfaces that not
            only look stunning but also enhance user engagement and
            satisfaction. From wireframes to prototypes, I bring your vision to
            life with a focus on usability and aesthetics.
          </p>
        </CardContent>
        <CardActions className="flex justify-center my-3">
          <button className="button text-white font-bold px-10 py-2">
